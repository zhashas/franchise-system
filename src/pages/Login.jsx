...
export default function Login() {
  ...
  const [step,     setStep]     = useState("credentials") // "credentials" | "fetching_role"
  ...
  const handleLogin = async (e) => {
    ...
    if (role === "admin")          navigate("/admin/dashboard")
      ...
      setError(`Unknown account role "${profile.role}". Please contact support.`)
      await supabase.auth.signOut()
    }
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex w-1/2 bg-blue-900 flex-col items-center justify-center p-10 text-white">
        <div className="bg-orange-500 p-4 rounded-full mb-6">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-white"
        ...
        <div className="mt-10 space-y-3 w-full max-w-xs">
          {[
            ...
            <div key={i} className="flex items-center gap-3 bg-blue-800/50 rounded-xl px-4 py-2.5">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-gray-50 p-8">
        <div className="w-full max-w-md">
          ...
          <div className="md:hidden text-center mb-8">
            ...
            <p className="text-xs text-gray-500 mt-1">Municipality of San Jose, Occidental Mindoro</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-orange-500">
            ...
            {loading && step === "fetching_role" && (
              <div className="bg-blue-50 border border-blue-200 text-blue-700 p-3 rounded-lg mb-5 text-sm flex items-center gap-2">
                ...
                <span>Verifying your account role, please wait…</span>
              </div>
            )}
