...
function ProtectedRoute({ children, allowedRoles }) {
  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center text-orange-500 font-semibold">Loading...</div>
  )
      ...
      <Routes>
        ...
        <Route path="/staff/dashboard" element={
          <ProtectedRoute allowedRoles={["staff"]}>
            <div className="p-8 text-2xl font-bold text-blue-900">Staff Dashboard 👨‍💼</div>
          </ProtectedRoute>
        } />
        ...
        <Route path="/applicant/appointments" element={
          <ProtectedRoute allowedRoles={["applicant"]}>
        ...
        <Route path="/applicant/franchise-renewal" element={
          <ProtectedRoute allowedRoles={["applicant"]}>
            <FranchiseRenewal />
        </ProtectedRoute>
        } />
